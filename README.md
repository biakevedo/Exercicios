...
Estruturas de Controle – if, else, switch, loops for, while e do-while

Funções / Métodos – criação de métodos com parâmetros e retorno

POO (Programação Orientada a Objetos) – classes, objetos, encapsulamento, herança, polimorfismo e abstração

Arrays e Coleções – manipulação de listas, arrays e mapas
